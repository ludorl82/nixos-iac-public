...
Edit `net-cfgs/network-diagram.md` — and ONLY that file — so
it no longer contradicts the repos. Do not commit; the driver script
commits exactly that file after you finish.
