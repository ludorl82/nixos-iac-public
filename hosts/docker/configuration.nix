## "docker" — the ex-bastion Pi 4 (2 GB), reborn 2026-08-05 as the fleet's
## private container registry (net-cfgs/backlog.md: registry item). The
## bastion role moved to pi-02 the same week; this box keeps exactly one
...
{ config, pkgs, lib, ... }:
{
  ...
  services.dockerRegistry = {
    ...
    # source files live in the bastion's Certificats/pki/docker.lab.example.
