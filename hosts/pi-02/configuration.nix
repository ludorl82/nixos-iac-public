...
{ config, pkgs, lib, nixpkgs, nixos-raspberrypi, ... }:
{
  imports = (with nixos-raspberrypi.nixosModules; [
    raspberry-pi-5.base
  ]) ++ [ ../../modules/k3s-agent.nix ../../modules/private-ca.nix ../../modules/ups-master.nix ../../modules/rack-wake.nix ../../modules/house-heartbeat.nix ../../modules/jumphost.nix ../../modules/console-container.nix ../../modules/ha-backup.nix ];
